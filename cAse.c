...
/**
 * getspecial - Wrapper getspecial static var.
 *
...
/**
 * getsvars - Get the staticvars wrapper.
 *
...
int help(char *cmd)
{
	...
	if (cmd == NULL)
	{
		s = "help: No builtin command entered.\n";
		r = _strlen(s);
		r = write(1, s, r);
		return (0);
	}
	...
	{
		s = "help: No help topic that match.\n";
		r = _strlen(s);
		r = write(1, s, r);
		return (0);
	}
